...
export class PiSubagentSession extends Context.Service<PiSubagentSession>()(
  ...
  {
    make: Effect.fn("PiSubagentSession.make")(function* (subagentId: SubagentId) {
  ...
  static readonly layerNoDeps = (subagentId: SubagentId) =>
    Layer.effect(PiSubagentSession, PiSubagentSession.make(subagentId));

  static readonly layer = (subagentId: SubagentId) =>
    PiSubagentSession.layerNoDeps(subagentId).pipe(Layer.provide(UnixSocketTransport.layer));
}
