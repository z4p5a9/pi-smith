...
export const make = Effect.fn("PiSubagentHarness.make")(function* () {
  ...
  return yield* Effect.succeed(SubagentHarness.of({ makeCommand }));
});

export const layer = Layer.effect(SubagentHarness, make());
