import { type Cause, Deferred, Effect, Exit, Queue, Schema, Semaphore, Stream } from "effect";
...
export const listen = Effect.fn("SubagentBridge.listen")(function* (subagentId: SubagentId) {
...
export const connect = Effect.fn("SubagentBridge.connect")(function* (subagentId: SubagentId) {
  const transport = yield* SubagentBridgeTransport;
  yield* Effect.annotateCurrentSpan({ subagentId });
