...
export class TestChildProcessSpawner extends Context.Service<TestChildProcessSpawner>()(
  ...
  static readonly layerNoDeps = Layer.effect(TestChildProcessSpawner, TestChildProcessSpawner.make);

  static readonly layer = Layer.effect(
    ChildProcessSpawner.ChildProcessSpawner,
    TestChildProcessSpawner,
  ).pipe(Layer.provideMerge(TestChildProcessSpawner.layerNoDeps));
}
